...
def read_network_file(network_filename, gene_to_id):
    ...
    with open(network_filename) as f:
        for row, record in enumerate(csv.reader(f, delimiter="\t")):
...
def run(
    ...
    try:
        ...
        for epoch in range(1, epochs + 1):
            ...
            # Evaluate metric at every epoch for accurate max_metric tracking
            if task_type == 'multiclass':
            ...
            # Print and log detailed results at the specified interval
